                            ...
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        <li>
                                            ...
                                            @else
                                                <a href="javascript:void(0);"
                                                    ...
                                                    class="{{ !Auth::user()->favoritePosts->where('pivot.post_id', $randomPost->id)->count() == 0? 'favoritePost': '' }}"><i
                                                        class="ion-heart"></i>{{ $randomPost->favorite_to_users->count() }}</a>
                                        ...
                                        <li><a href="#"><i class="ion-eye"></i>{{ $randomPost->view_count }}</a>
                                        </li>
                                    </ul>
                                </div><!-- blog-info -->
                            </div><!-- single-post -->
                    ...
                    <div class="comment-form">
                        ...
                        @else
                            <form method="post" action="{{ route('comment.store', $post->id) }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <textarea name="comment" rows="2" class="text-area-messge form-control" placeholder="Write a comment"
                                            aria-required="true" aria-invalid="false"></textarea>
                                    </div><!-- col-sm-12 -->
                                    <div class="col-sm-12">
                                        <button style="font-size: 18px" class="submit-btn" type="submit"
                                            id="form-submit"><b>Submit</b></button>
                                    </div><!-- col-sm-12 -->
                                </div><!-- row -->
                            </form>
                        @endguest
                                ...
                                <div class="comment">
                                    <div class="post-info">
                                        ...
                                        <div class="middle-area">
                                            ...
                                            <h6 class="date">on {{ $comment->created_at->diffForHumans() }}
                                            </h6>
                                        </div>
                                    </div><!-- post-info -->
                                    <p>{{ $comment->comment }}</p>

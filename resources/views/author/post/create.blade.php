                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                &nbsp;
                                <div class="form-line {{ $errors->has('categories') ? 'focused errors' : '' }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                &nbsp;
                                <div class="form-line {{ $errors->has('tags') ? 'focused errors' : '' }}">
                            ...
                            {{-- ./ select for tag --}}
                            <a class="button btn btn-danger m-t-15 waves-effect"
                                href="{{ route('author.post.index') }}">BACK</a>

                                    ...
                                    @foreach ($posts as $key => $post)
                                        ...
                                        <tr>
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#">
                                                            ...
                                                            src="{{ Storage::disk
                                                            ('public')->url('profile/'.$comment->user->image) }}"
                                                            width="64" height="64">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        ...
                                                        $comment->post->slug.'#comments') }}">Reply</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media">
                                                    <div class="media-right">
                                                        ...
                                                        $comment->post->slug) }}">
                                                            <img class="media-object"
                                                            src="{{ Storage::disk
                                                            ('public')->url('post/'.$comment->post->image) }}"
                                                            width="64" height="64">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-form-{{ $comment->id }}" method="POST" action="{{
                                                route('author.comment.destroy',$comment->id) }}" style="display:
                                                none;">
                                                @csrf
                                                @method('DELETE')
                                                </form>

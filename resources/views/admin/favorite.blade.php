            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL FAVORITE POSTS
                            <span class="badge bg-blue"> {{ $favoritePost->count() }} </span>
                        </h2>
                    </div>
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    @foreach ($favoritePost as $key => $post)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="removeFavorite-form-{{ $post->id }}"
        ...
        function removeFavoritePost(id) {
            swal({
                ...
                if (result.value) {
                    ...
                    document.getElementById('removeFavorite-form-' + id).submit();
                    console.log(id);
                } else if (

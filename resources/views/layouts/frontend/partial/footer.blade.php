        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-section">
                    ...
                    <p class="copyright">{{ config('app.name') }} @ 2022. All rights reserved.</p>
                    <p class="copyright">Designed by <a href="https://colorlib.com" target="_blank">Colorlib</a>and
                        Develop By <a href="https://github.com/shahriarshawon01" target="_blank">SR Shawon</a></p>
                    <ul class="icons">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        @foreach ($categories as $category)
                            <li><a href="{{ route('category.posts', $category->slug) }}">{{ $category->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div><!-- footer-section -->
